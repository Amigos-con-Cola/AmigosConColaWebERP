    ...
    let api = {
      ...
      clearNotification: (id) => {
        ...
        notification &&
          ...
          notification.onClear({ dismissed: !1 });
      },
    };
      ...
      selectStory: (titleOrId = void 0, name2 = void 0, options2 = {}) => {
        ...
        if (hash)
          if (name2)
            ...
            let entry = titleOrId
              ? hash[titleOrId] || hash[k(titleOrId)]
              : hash[kindSlug];
      ...
      api = {
        ...
        getDocsUrl: ({ subpath, versioned, renderer }) => {
          ...
          if (
            ...
            let rendererName = scope.STORYBOOK_RENDERER.split("/")
              .pop()
              ?.toLowerCase();
            rendererName &&
...
var curriedTransparentize = curry(transparentize),
  ...
  components = {
    h1: (props) =>
      import_react3.default.createElement(H1, {
        ...nameSpaceClassNames(props, "h1"),
      }),
    h2: (props) =>
      import_react3.default.createElement(H2, {
        ...nameSpaceClassNames(props, "h2"),
      }),
    h3: (props) =>
      import_react3.default.createElement(H3, {
        ...nameSpaceClassNames(props, "h3"),
      }),
    h4: (props) =>
      import_react3.default.createElement(H4, {
        ...nameSpaceClassNames(props, "h4"),
      }),
    h5: (props) =>
      import_react3.default.createElement(H5, {
        ...nameSpaceClassNames(props, "h5"),
      }),
    h6: (props) =>
      import_react3.default.createElement(H6, {
    ...
    hr: (props) =>
      import_react3.default.createElement(HR, {
        ...nameSpaceClassNames(props, "hr"),
      }),
    dl: (props) =>
      import_react3.default.createElement(DL, {
        ...nameSpaceClassNames(props, "dl"),
      }),
    blockquote: (props) =>
      import_react3.default.createElement(Blockquote, {
    ...
    img: (props) =>
      import_react3.default.createElement(Img, {
    ...
    li: (props) =>
      import_react3.default.createElement(LI, {
    ...
    p: (props) =>
      import_react3.default.createElement(P, {
        ...nameSpaceClassNames(props, "p"),
      }),
    code: (props) =>
      import_react3.default.createElement(Code, {
        ...nameSpaceClassNames(props, "code"),
      }),
    tt: (props) =>
      import_react3.default.createElement(TT, {
        ...nameSpaceClassNames(props, "tt"),
      }),
    resetwrapper: (props) =>
      import_react3.default.createElement(ResetWrapper, {
  ...
  Badge = ({ ...props }) =>
    import_react3.default.createElement(BadgeWrapper, { ...props }),
  LEFT_BUTTON = 0,
  isPlainLeftClick = (e) =>
  ...
  Link22 = ({
    ...
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        children,
        withArrow &&
          import_react3.default.createElement(ChevronRightIcon, null),
      ),
    ),
  ...
  LazySyntaxHighlighter = (0, import_react3.lazy)(async () => {
    let { SyntaxHighlighter: SyntaxHighlighter3 } = await import(
      "./syntaxhighlighter-JOJW2KGS-VF6EEVPI.js"
    );
    return (
      languages.length > 0 &&
      ...
      {
        default: (props) =>
          import_react3.default.createElement(SyntaxHighlighter3, { ...props }),
      }
    );
  }),
  LazySyntaxHighlighterWithFormatter = (0, import_react3.lazy)(async () => {
    ...
    return (
      ...
      {
        default: (props) =>
          import_react3.default.createElement(SyntaxHighlighter3, {
            ...props,
            formatter,
          }),
      }
  ...
  SyntaxHighlighter22 = (props) =>
    import_react3.default.createElement(
      ...
      props.format !== !1
        ...
        : import_react3.default.createElement(LazySyntaxHighlighter, {
            ...props,
          }),
    );
  ...
  Button = (0, import_react3.forwardRef)(
    (
      ...
      if (
        ...
        let buttonContent = import_react3.default.Children.toArray(
          props.children,
...
var StyledButton = newStyled("button", {
  ...
  IconButton = (0, import_react3.forwardRef)(
...
var useWindowResizeListener = function (listener) {
  ...
  Input = Object.assign(
    newStyled(
      (0, import_react3.forwardRef)(function (
  ...
  LazyWithTooltip = (0, import_react3.lazy)(() =>
    import("./WithTooltip-Y7J54OF7-CEHQ77YF.js").then((mod) => ({
...
var Note = newStyled.div(({ theme }) => ({
  ...
  TooltipNote = ({ note, ...props }) =>
    import_react3.default.createElement(Note, { ...props }, note),
  ...
  ListItem = ({
    ...
    return import_react3.default.createElement(
      ...
      icon &&
        import_react3.default.createElement(Left, { ...commonProps }, icon),
      title || center
        ? import_react3.default.createElement(
            Center,
        ...
        : null,
      right &&
        import_react3.default.createElement(Right, { ...commonProps }, right),
    );
  };
  ...
  FlexBar = ({ children, backgroundColor, className, ...rest }) => {
    ...
    return import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        right
          ? import_react3.default.createElement(Side, { right: !0 }, right)
          : null,
      ),
    );
  };
    ...
    AddonTab = (0, import_react3.useCallback)(
      ({ menuName, actions }) => {
        let isAddonsActive = invisibleList.some(({ active }) => active),
          [isTooltipVisible, setTooltipVisible] = (0, import_react3.useState)(
            !1,
          );
        return import_react3.default.createElement(
          import_react3.default.Fragment,
  ...
  EmptyTabContent = ({ title, description, footer }) =>
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        description &&
          import_react3.default.createElement(Description, null, description),
      ),
      footer,
    ),
  ignoreSsrWarning2 =
        ...
        : import_react3.default.createElement(
            ...
            import_react3.default.createElement(
              ...
              import_react3.default.createElement(
                ...
                import_react3.default.createElement(AddonTab, {
                  menuName,
                  actions,
                }),
              ),
      ...
      (acc, item, index3) =>
        item
          ? import_react3.default.createElement(
              ...
              acc,
              index3 > 0
                ? import_react3.default.createElement(Separator, {
                    key: `s-${index3}`,
                  })
                : null,
              item.render() || item,
...
`,
  ...
  Symbols = (0, import_react3.memo)(function ({
  ...
  StorybookLogo = ({ alt, ...props }) =>
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        import_react3.default.createElement("use", {
          fill: "#FF4785",
          fillRule: "nonzero",
          xlinkHref: "#a",
        }),
      ...
      return (
        ...
        import_react3.default.createElement(
          ...
          import_react3.default.createElement(
            ProgressTrack,
            null,
            import_react3.default.createElement(ProgressBar, {
          ...
          import_react3.default.createElement(
            ...
            message,
            value2 < 1 &&
              import_react3.default.createElement(Ellipsis, { key: message }),
          ),
        )
      );
    }
