          ...
          (_this.setHighlightedIndex = function (
            ...
            highlightedIndex === void 0 &&
              ...
              _this.internalSetState(
                _extends2({ highlightedIndex }, otherStateToSet),
              );
          }),
...
function callOnChangeProps(action, state, newState) {
  ...
  Object.keys(state).forEach(function (key) {
    ...
    props.onStateChange &&
      ...
      props.onStateChange(_extends2({ type }, changes));
}
...
var { document: document6 } = scope,
  ...
  Search = import_react21.default.memo(function ({
    ...
    let api = useStorybookApi(),
      ...
      onInputValueChange = (0, import_react21.useCallback)(
